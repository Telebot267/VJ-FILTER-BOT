...
# Bot information
SESSION = environ.get('SESSION', 'Search your Movies...')
API_ID = int(environ.get('API_ID', '23432282'))
API_HASH = environ.get('API_HASH', 'e2fa2a138de4e0bdf41940795afac611')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002240103548'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1760280961').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001838868538').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://telebot267:Ankit@123@cluster0.qnuugxh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieswebseries_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/thewebseries4u')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movieswebseries_group) # Support Chat Link Without https:// or @
